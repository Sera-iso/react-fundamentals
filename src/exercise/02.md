...
* React creates the elements, similar to document.createElement('element')
* ReactDOM renders elements on to the page, similar to rootElement.append('element').
Having them separate allows us to create the core React elements for any of these platforms with React and render them on the page with the platform specific packages:Native for APP, ReactVR and/or DOM for websites, ...
